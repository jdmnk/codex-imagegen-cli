...
- `generate`, `edit`, and `batch` workflows that call the stable Codex `/responses` hosted `image_generation` tool path.
...
- Source distribution, wheel build, pytest coverage, and README quickstart.
